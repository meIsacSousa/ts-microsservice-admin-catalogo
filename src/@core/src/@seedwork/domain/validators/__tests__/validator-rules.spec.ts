...
describe("Validations rules Unit Tests", () => {
    ...
    const asserts: ExpectedAssert[] = [
      {
        ...
        property: "propertyName",
        rule: "string",
        error: "The property propertyName must be a string",
      },
      {
        value: 0,
        property: "propertyName",
    ...
    const asserts: ExpectedAssert[] = [
      {
        ...
        rule: "maxLength",
        error:
          "The property propertyName must be less than or equal to 3 characters.",
        params: [3],
      },
      {
        value: "bigger",
        ...
        rule: "maxLength",
        error:
          "The property propertyName must be less than or equal to 4 characters.",
        params: [4],
      },
    ];
    ...
    const asserts: ExpectedAssert[] = [
      {
        ...
        rule: "maxLength",
        error:
          "The property propertyName must be less than or equal to 5 characters.",
        params: [5],
      },
      {
        value: "less",
        ...
        rule: "maxLength",
        error:
          "The property propertyName must be less than or equal to 6 characters.",
        params: [6],
      },
      {
        value: null,
    ...
    const asserts: ExpectedAssert[] = [
      {
        ...
        property: "propertyName",
        rule: "boolean",
        error: "The property propertyName must be a boolean",
      },
      {
        value: 0,
        property: "propertyName",
  ...
  it("Should throw an error when combine required and string", () => {
    ...
    asserts.forEach((assert) => {
      expect(() =>
        ValidatorRules.values(assert.value, assert.property).required().string()
      ).toThrowError(assert.error);
    });
  });
  ...
  it("Should throw an error when combine required, string and maxLength", () => {
    ...
    asserts.forEach((assert) => {
      expect(() =>
        ValidatorRules.values(assert.value, assert.property)
          .required()
          .string()
          .maxLength(assert.params[0])
      ).toThrowError(assert.error);
    });
  });
