...
describe("CategoryValidator tests", () => {
    ...
    test("Invalidation cases for name field", () => {
        const asserts = [
            ...
            {
                props: { name: "a".repeat(256) }, errors: [
                    "name must be shorter than or equal to 255 characters",
                ]
            },
            {
    ...
    test("Valid cases for name field", () => {
        ...
        asserts.forEach(({ props }) => {
            ...
            expect(validator.validatedData)
                .toStrictEqual(new CategoryRules(props));
        });
    });
    ...
    test("Invalidation cases for description field", () => {
        const asserts = [
            {
                props: { description: 1 }, errors: [
                    "description must be a string",
                ]
            },
            {
                props: { description: true }, errors: [
                    "description must be a string",
                ]
            }
        ]
    ...
    test("Valid cases for description field", () => {
        ...
        asserts.forEach(({ props }) => {
            ...
            expect(validator.errors).toBeNull();
            expect(validator.validatedData)
                .toStrictEqual(new CategoryRules(props as any));
        });
    });
    ...
    test("Invalidation cases for is_active field", () => {
        const asserts = [
            {
                props: { is_active: 1 }, errors: [
                    "is_active must be a boolean value",
                ]
            },
            {
                props: { is_active: "true" }, errors: [
                    "is_active must be a boolean value",
                ]
            },
            {
                props: { is_active: 0 }, errors: [
                    "is_active must be a boolean value",
                ]
            }
        ]
    ...
    test("Invalidation cases for created_at field", () => {
        const asserts = [
            {
                props: { created_at: 1 }, errors: [
                    "created_at must be a Date instance",
                ]
            },
            {
                props: { created_at: "true" }, errors: [
                    "created_at must be a Date instance",
                ]
            }
        ]
